# Velune Trace v0.5.2 — Release Checklist
...
- [ ] Full test suite (126 tests, 58 subtests) passes in a clean exported Git index
- [ ] Test suite passes on a genuinely fresh clone with no pre-existing `examples/sample.mcap`
