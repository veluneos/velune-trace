...
from velune_trace.cli.validation_report import main as validation_report_main
...
def print_usage():
    ...
    print("  evidence-window    Extract a reproducible evidence window")
    print("  validation-report  Generate anonymous validation report")
